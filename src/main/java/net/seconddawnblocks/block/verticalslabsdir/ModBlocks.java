...
import net.seconddawnblocks.block.TileBlock;
...
public class ModBlocks {
    public static final Block NINE_FISH = registerBlock("nine_fish",
            new Block(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).sounds(BlockSoundGroup.GLASS)));
...
*/
    ...
    public static final ItemGroup SHIPYARD = Registry.register(
            ...
            Identifier.of(SecondDawnBlocks.MOD_ID, "seconddawnblocks"), //name
